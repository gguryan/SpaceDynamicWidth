...
#inputs = load_params('C:/Users/gjg882/Desktop/Code/SpaceDynamicWidth/fixed_width_inputs_test_3x3.txt')
#output file path
#ds_file = 'FixedWidthTest_test_3x3.nc'


inputs = load_params('C:/Users/gjg882/Desktop/Code/SpaceDynamicWidth/fixed_width_inputs_ctrl_3x3.txt')
#output file path
ds_file = 'FixedWidthTest_ctrl_3x3.nc'
...
mg.set_watershed_boundary_condition_outlet_id(1, 
                                              mg.at_node['topographic__elevation'],
                                              -9999.)

#Check boundary conditions
#imshow_grid(mg, mg.status_at_node, color_for_closed='blue')
imshow_grid(mg, mg.at_node['topographic__elevation'])
...
#K * Q**m * S**n
Er_manual = 1e-5 * (10000**0.5) * 0.1 * np.exp(-0/1)
...
br_erosion_term = space._br_erosion_term

soil_H = mg.at_node['soil__depth']

slope_test = space._slope
...
# 
# plt.figure()
# width_test = mg.at_node['channel__width'][mg.core_nodes] * mg.at_node['K'][mg.core_nodes]
# 
# plt.plot(width_test)
# 
# #%%
