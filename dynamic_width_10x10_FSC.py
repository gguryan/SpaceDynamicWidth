...
#%%
inputs = load_params('dynamic_w_inputs_10x10_V5.txt')
#inputs = load_params('C:/Users/gjg882/Desktop/Code/SpaceDynamicWidth/dynamic_w_inputs.txt')


#%%

save_output = True #Do you want to save the model output to netcdf file?
ds_file_out = '10x10_1myr_V5_fsc500.nc'
slope_init = .012

#%%

#Model time in years
space_runtime = 500000 #todo change var names to model_runtime
